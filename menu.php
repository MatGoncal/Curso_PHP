<nav class="modulos">
    <div class="modulo azul-escuro">
        <h3>16. Consumo de API </h3>
        <ul>
            <li>
                <a href="exercicio.php?dir=apis&file=api_pokemon">
                    API Pokemon
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=apis&file=api_cep">
                    API CEP
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=apis&file=api_starWars">
                    API Star Wars
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=apis&file=api_curl">
                    API com CURL
                </a>
            </li>
        </ul>
